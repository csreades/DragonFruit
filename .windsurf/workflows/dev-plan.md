...
This document outlines the required format and structure for all Development Plans created by agents. Development plans need to be markdown files in the Scratch directory.
