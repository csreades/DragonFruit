...
export interface Island {
    ...
    internalCenter?: { x: number; y: number; z: number }; // Calculated Pole of Inaccessibility (mm)
    internalRadius?: number; // Radius of the largest inscribed sphere at the center (mm)
    seedVoxel?: { x: number; y: number; z: number }; // Grid coordinates (x,y,z) of the internal center for Basin Filling
}
