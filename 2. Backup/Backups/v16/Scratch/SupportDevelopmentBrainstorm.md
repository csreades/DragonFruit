...
2. **Modular Support Types**
   - Create base class/helpers for support modules.
   - Implement primary MSLA straight support module, then mini variant.

3. **Placement & Snapping Rules**
